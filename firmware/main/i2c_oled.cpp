...
namespace oled {
    const uint8_t font8x8_basic[62][8] = {
        [0] = {0x3C, 0x42, 0x42, 0x42, 0x42, 0x42, 0x3C, 0x00}, // '0'
        [1] = {0x10, 0x30, 0x10, 0x10, 0x10, 0x10, 0x38, 0x00}, // '1'
        ...
        [33] = {0x42, 0x24, 0x18, 0x18, 0x18, 0x24, 0x42, 0x00}, // 'X'
        [34] = {0x81, 0x42, 0x24, 0x18, 0x18, 0x18, 0x18, 0x00}, // 'Y'
        [35] = {0x7E, 0x02, 0x04, 0x08, 0x10, 0x20, 0x7E, 0x00}, // 'Z'
        [36] = {0x00, 0x00, 0x3C, 0x02, 0x3E, 0x42, 0x3E, 0x00}, // 'a'
        [37] = {0x40, 0x40, 0x5C, 0x62, 0x42, 0x62, 0x5C, 0x00}, // 'b'
        [38] = {0x00, 0x00, 0x3C, 0x42, 0x40, 0x42, 0x3C, 0x00}, // 'c'
        [39] = {0x02, 0x02, 0x3A, 0x46, 0x42, 0x46, 0x3A, 0x00}, // 'd'
        [40] = {0x00, 0x00, 0x3C, 0x42, 0x7E, 0x40, 0x3C, 0x00}, // 'e'
        [41] = {0x1C, 0x22, 0x20, 0x78, 0x20, 0x20, 0x20, 0x00}, // 'f'
        [42] = {0x00, 0x00, 0x3A, 0x46, 0x46, 0x3A, 0x02, 0x3C}, // 'g'
        [43] = {0x40, 0x40, 0x5C, 0x62, 0x42, 0x42, 0x42, 0x00}, // 'h'
        [44] = {0x10, 0x00, 0x30, 0x10, 0x10, 0x10, 0x38, 0x00}, // 'i'
        [45] = {0x08, 0x00, 0x18, 0x08, 0x08, 0x48, 0x48, 0x30}, // 'j'
        [46] = {0x40, 0x40, 0x44, 0x48, 0x70, 0x48, 0x44, 0x00}, // 'k'
        [47] = {0x30, 0x10, 0x10, 0x10, 0x10, 0x10, 0x38, 0x00}, // 'l'
        [48] = {0x00, 0x00, 0x6C, 0x52, 0x52, 0x52, 0x52, 0x00}, // 'm'
        [49] = {0x00, 0x00, 0x5C, 0x62, 0x42, 0x42, 0x42, 0x00}, // 'n'
        [50] = {0x00, 0x00, 0x3C, 0x42, 0x42, 0x42, 0x3C, 0x00}, // 'o'
        [51] = {0x00, 0x00, 0x5C, 0x62, 0x62, 0x5C, 0x40, 0x40}, // 'p'
        [52] = {0x00, 0x00, 0x3A, 0x46, 0x46, 0x3A, 0x02, 0x02}, // 'q'
        [53] = {0x00, 0x00, 0x5C, 0x62, 0x40, 0x40, 0x40, 0x00}, // 'r'
        [54] = {0x00, 0x00, 0x3E, 0x40, 0x3C, 0x02, 0x7C, 0x00}, // 's'
        [55] = {0x20, 0x20, 0x78, 0x20, 0x20, 0x22, 0x1C, 0x00}, // 't'
        [56] = {0x00, 0x00, 0x42, 0x42, 0x42, 0x46, 0x3A, 0x00}, // 'u'
        [57] = {0x00, 0x00, 0x42, 0x42, 0x24, 0x24, 0x18, 0x00}, // 'v'
        [58] = {0x00, 0x00, 0x42, 0x42, 0x5A, 0x66, 0x42, 0x00}, // 'w'
        [59] = {0x00, 0x00, 0x42, 0x24, 0x18, 0x24, 0x42, 0x00}, // 'x'
        [60] = {0x00, 0x00, 0x42, 0x42, 0x46, 0x3A, 0x02, 0x3C}, // 'y'
        [61] = {0x00, 0x00, 0x7E, 0x04, 0x18, 0x20, 0x7E, 0x00}, // 'z'
    };
    ...
    const uint8_t font8x8_basic_symbols[7][8] = {
        ...
        [4] = {0x3C, 0x52, 0x93, 0x95, 0x99, 0x81, 0x42, 0x3C}, // 'zegar'
        [5] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0x60, 0x00}, // 'kropka'
        [6] = {0x00, 0x60, 0x60, 0x00, 0x00, 0x60, 0x00, 0x00}, // ':'
    };
        ...
        public:
            ...
            void putc(char c, bool color = false) {
                if (c >= '0' && c <= '9') {
                    ...
                    draw_symbol(coursor_x, coursor_y, font8x8_basic[c - 'a' + 36], 8, 8, color);
                    coursor_x += 8;
                } else {
                    switch (c) {
                    case ',':
                    case '.':
                        ...
                        break;
                    case ':':
                        draw_symbol(coursor_x, coursor_y, font8x8_basic_symbols[6], 8, 8, color);
                        coursor_x += 8;
                        break;
                    case '\n':
                        coursor_x = 8;
                        coursor_y += 10;
                        if (coursor_y + 10 > y_size) {
                            coursor_y = 0;
                        }
                        break;
                    case '%':
